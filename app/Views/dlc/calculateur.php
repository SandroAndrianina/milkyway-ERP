...
<main class="flex-1 flex flex-col relative w-full">
    <!-- TopAppBar -->
    <header class="w-full h-20 sticky top-0 z-40 bg-surface dark:bg-surface-dim border-b border-outline-variant flex justify-between items-center px-margin-desktop ml-auto">
    ...
    <!-- Content Canvas -->
    <div class="p-margin-desktop max-w-[1200px] mx-auto w-full flex-1">
        <div class="mb-8">
