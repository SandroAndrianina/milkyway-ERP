                ...
                <table class="w-full text-left border-collapse" id="stock-table">
                    <thead>
                        <tr class="bg-surface-container-low border-b border-surface-variant">
                            ...
                            <th class="py-3 px-4 font-label-md text-on-surface-variant">Type</th>
                ...
                <div>
                    ...
                    <div class="flex p-1 bg-surface-container-low rounded-lg">
                        <label class="flex-1 text-center cursor-pointer">
                            <input checked class="peer sr-only" name="type" type="radio" value="entree">
                            <div class="py-2 rounded-md font-label-md peer-checked:bg-surface peer-checked:text-secondary peer-checked:shadow-sm text-on-surface-variant transition-all">Entrée</div>
                        </label>
                        <label class="flex-1 text-center cursor-pointer">
                            <input class="peer sr-only" name="type" type="radio" value="sortie">
                            <div class="py-2 rounded-md font-label-md peer-checked:bg-surface peer-checked:text-primary peer-checked:shadow-sm text-on-surface-variant transition-all">Sortie</div>
                        </label>
                    </div>
                </div>
                <!-- Produit -->
