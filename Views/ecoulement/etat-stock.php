...
<main class="flex-1 flex flex-col relative w-full overflow-x-hidden">
    ...
    <div class="p-4 md:p-margin-desktop flex-1">
        <div class="max-w-7xl mx-auto">
            ...
            <!-- Carte Valeur Totale (masquée pour le rôle stocks) -->
            <div id="valeur-totale-card" class="bg-primary text-on-primary rounded-xl p-md mb-6 border border-primary-container shadow-[0_4px_24px_rgba(8,67,101,0.15)] flex items-center justify-between">
                <div class="flex items-center gap-4">
            ...
            <div class="bg-surface-container-lowest rounded-xl p-md border border-surface-container-highest shadow mb-6">
                <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
                    ...
                    <div class="flex items-center gap-3">
                        <!-- Toggle Financier / Quantité (masqué pour stocks) -->
                        <div class="flex p-1 bg-surface-container-low rounded-lg" id="toggle-mode-group">
                    ...
                    <table class="w-full text-left border-collapse" id="stock-table">
                        <thead>
                            <tr class="bg-surface-container-low text-on-surface-variant border-b border-outline-variant">
                                ...
                                <th id="th-prix-total" class="p-4 font-label-md text-label-md font-semibold text-right whitespace-nowrap">Prix Total (Ar)</th>
                    ...
                    <table class="w-full text-left border-collapse" id="export-preview-table">
                        <thead>
                            <tr class="bg-surface-container-low border-b">
                                ...
                                <th class="p-2 font-label-md text-right" id="export-th-prix">Prix Total (Ar)</th>
