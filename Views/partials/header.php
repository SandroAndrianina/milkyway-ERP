...
<body class="flex flex-row min-h-screen text-on-surface font-body-md">
    ...
    <button id="sidebar-mobile-open" class="lg:hidden fixed top-4 left-4 z-30 w-10 h-10 rounded-full bg-primary text-on-primary flex items-center justify-center shadow-md">
        <span class="material-symbols-outlined text-[22px]">menu</span>
    </button>

    <!-- Overlay assombri derrière la sidebar ouverte (mobile/tablette) -->
    <div id="sidebar-overlay" class="lg:hidden fixed inset-0 bg-on-background/40 z-40 hidden"></div>
